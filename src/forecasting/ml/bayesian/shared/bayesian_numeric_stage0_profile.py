...
def run_stage0(args: argparse.Namespace) -> Path:
    ...
    (output_dir / "bayesian_numeric_stage0_profile.json").write_text(json.dumps(artifact, indent=2), encoding="utf-8")
    _write_candidate_csv(output_dir / "bayesian_numeric_stage0_candidates.csv", results)
    return output_dir
