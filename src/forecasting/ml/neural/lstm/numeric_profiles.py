...
from src.forecasting.common.model_zoo_forecast import neural_lstm_surrogate_predict
...
MODULE_TAG = "neural_lstm"
MODEL_ID = "neural_lstm"
MODEL_VERSION = "1.0.0"
FAMILY_ROOT_NAME = "NeuralTS_LSTM"
FAMILY_ROOT_ENV = "PIPELINE_PARQUET_NEURALTS_LSTM_ROOT"
...
STAGE1_FEATURE_BLOCKS = {
    ...
    "calendar_block": ["hour_of_day", "day_of_week"],
}
STAGE1_FORMULATION_OPTIONS = {
    "input_schema": ["multivariate_sequence"],
    "lookback_design": ["adaptive_seq_len"],
}
...
def predict_fn(*, y_hist: np.ndarray, horizon_bars: int, quantiles: Sequence[float], seq_len: int, seed: int, model_params: Dict[str, Any] | None = None, x_hist: np.ndarray | None = None, x_last: np.ndarray | None = None) -> Tuple[Dict[float, float], Dict[str, Any]]:
    ...
    return neural_lstm_surrogate_predict(
        y_hist=y_hist,
