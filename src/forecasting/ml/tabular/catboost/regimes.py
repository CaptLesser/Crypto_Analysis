...
def _write_month_parts(
    ...
    if not month_frames:
        return []
    out_cols = list(forecast_output_columns("cb", horizon_minutes)) + [
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Walk-forward CatBoost regime forecasting from canonical axis labels.")
