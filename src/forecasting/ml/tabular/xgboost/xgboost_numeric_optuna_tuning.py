...
MODEL_SPEC = TabularOptunaModelSpec(
    ...
    short_label="XGB",
    numerics_module_import_path="src.forecasting.ml.tabular.xgboost.numerics",
    optuna_profile_import_path="src.forecasting.ml.tabular.xgboost.xgboost_optuna_profile",
    output_root=Path("logs") / "diagnostics" / "xgboost_numeric_optuna_combo_tuning",
    default_study_name_prefix="xgboost_numeric_combo_rmse",
