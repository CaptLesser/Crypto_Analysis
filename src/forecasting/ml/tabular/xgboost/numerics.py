...
from src.features.numeric_forecast_profiles import normalize_refit_cadence, resolve_xgb_default_combo_profile, resolve_xgb_default_refit_policy
...
from src.forecasting.ml.tabular.xgboost.numeric_adapter import fit_regressor, predict_block
from src.forecasting.ml.tabular.xgboost.numeric_feature_profiles import feature_profile_label, select_feature_columns
from src.forecasting.ml.tabular.xgboost.numeric_profiles import *
from src.forecasting.ml.tabular.xgboost.numeric_profiles import (
...
globals().update(
    build_numeric_family_module(
        NumericFamilyModuleSpec(
            ...
            deadzone_env_prefix="XGB_NUMERIC",
            ...
            resolve_default_combo_profile_fn=resolve_xgb_default_combo_profile,
            resolve_default_refit_policy_fn=resolve_xgb_default_refit_policy,
