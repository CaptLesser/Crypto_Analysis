...
from src.forecasting.ml.tabular.elasticnet.numeric_adapter import fit_regressor, predict_block
from src.forecasting.ml.tabular.elasticnet.numeric_feature_profiles import feature_profile_label, select_feature_columns
from src.forecasting.ml.tabular.elasticnet.numeric_profiles import *
from src.forecasting.ml.tabular.elasticnet.numeric_profiles import (
    default_training_window_months_for_combo,
    normalize_refit_cadence,
    regressor_profile_label,
    resolve_en_default_combo_profile,
    resolve_en_default_refit_policy,
...
globals().update(
    build_numeric_family_module(
        NumericFamilyModuleSpec(
            ...
            family_name="ElasticNet",
            prediction_prefix="en",
            log_prefix="[en_numeric]",
            ...
            deadzone_env_prefix="EN_NUMERIC",
            ...
            resolve_default_combo_profile_fn=resolve_en_default_combo_profile,
            resolve_default_refit_policy_fn=resolve_en_default_refit_policy,
